      ...
      {markers.map((marker) => (
        ...
        >
          <button
            ...
            className="bg-mint flex h-7 w-7 cursor-pointer items-center justify-center rounded-full border-2 border-white text-[11px] leading-none font-semibold text-white shadow-md transition-transform hover:scale-110"
